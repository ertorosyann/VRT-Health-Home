...
const Footer = () => {
  ...
  const handleServiceNavigation = (serviceId: string) => {
    ...
    if (
      ...
      // If on services page, just scroll
                ...
                >
                  ...
                  >
                    ...
                    {social.icon === 'linkedin' && (
                      <path
                        fillRule="evenodd"
                        d="M19 0H5a5 5 0 00-5 5v14a5 5 0 005 5h14a5 5 0 005-5V5a5 5 0 00-5-5zM8 19H5V8h3v11zM6.5 6.732c0 1.146-.928 2.064-2.064 2.064-1.136 0-2.064-.918-2.064-2.064S3.3 4.668 4.436 4.668c1.136 0 2.064.918 2.064 2.064zM20 19h-3v-5.604c0-3.368-4-3.113-4 0V19h-3V8h3v1.765c1.396-2.586 7-2.777 7 2.476V19z"
                        clipRule="evenodd"
                      />
                    )}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12">
            ...
            <div className="sm:col-span-1 lg:col-span-1">
              ...
              <ul className="space-y-3">
                {[
                  {
                    name: getMainTranslation(locale, 'footer.nursingCare'),
                    id: 'nursing-care',
                  },
                  {
                    name: getMainTranslation(locale, 'footer.physicalTherapy'),
                    id: 'physical-therapy',
                  },
                  {
                    name: getMainTranslation(
                      locale,
                      'footer.occupationalTherapy'
                    ),
                    id: 'occupational-therapy',
                  },
                  {
                    name: getMainTranslation(locale, 'footer.speechTherapy'),
                    id: 'speech-therapy',
                  },
                  {
                    name: getMainTranslation(locale, 'footer.personalCare'),
                    id: 'personal-care',
                  },
                  {
                    name: getMainTranslation(locale, 'footer.medicalEquipment'),
                    id: 'medical-equipment',
                  },
                  {
                    name: getMainTranslation(locale, 'footer.dietician'),
                    id: 'dietician',
                  },
                  {
                    name: getMainTranslation(
                      locale,
                      'footer.medicalSocialServices'
                    ),
            ...
            <div className="sm:col-span-1 lg:col-span-1">
              <h3 className="text-lg font-bold text-gray-900 mb-6">
                {getMainTranslation(locale, 'footer.contact')}
              </h3>
            ...
            <div className="sm:col-span-2 lg:col-span-1">
              <h3 className="text-lg font-bold text-gray-900 mb-6">
                {getMainTranslation(locale, 'footer.ourLocation')}
              </h3>
