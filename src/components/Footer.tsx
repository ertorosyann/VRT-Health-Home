        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <h3 className="text-xl font-bold">{company[currentLocale as keyof typeof company].name}</h3>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                ...
                >
                  {navigation[currentLocale as keyof typeof navigation].home}
                </button>
              </li>
              <li>
                <button
                  ...
                  className="text-gray-300 hover:text-white transition-colors cursor-pointer text-left"
                >
                  {navigation[currentLocale as keyof typeof navigation].about}
                </button>
              </li>
              <li>
                <button
                  ...
                  className="text-gray-300 hover:text-white transition-colors cursor-pointer text-left"
                >
                  {navigation[currentLocale as keyof typeof navigation].services}
                </button>
              </li>
              <li>
                <button
                  ...
                  className="text-gray-300 hover:text-white transition-colors cursor-pointer text-left"
                >
                  {navigation[currentLocale as keyof typeof navigation].contact}
                </button>
              </li>
            </ul>
          </div>
