...
export const servicesTranslations = {
  en: {
    ...
    whoNeedsCare: {
      ...
      note: 'You must have a referral. This means that if you are enrolled in a managed care plan, the care must be authorized either by your primary care physician or by Mobile Doctors.'
    },
    paymentOptions: {
    ...
    coverage: {
      ...
      features: [
        'Primary service area within 100 miles',
  ...
  zh: {
    ...
    whoNeedsCare: {
      ...
      note: '您必须有转诊。这意味着如果您参加了管理式护理计划，护理必须由您的主治医生或移动医生授权。'
    },
    paymentOptions: {
      title: '谁为这些服务付费？',
  ...
  es: {
    ...
    whoNeedsCare: {
      ...
      note: 'Debe tener una referencia. Esto significa que si está inscrito en un plan de cuidado administrado, el cuidado debe ser autorizado ya sea por su médico de atención primaria o por Mobile Doctors.'
    },
    paymentOptions: {
    ...
    coverage: {
      ...
      features: [
        'Área de servicio principal dentro de 100 millas',
  ...
  fr: {
    ...
    whoNeedsCare: {
      ...
      note: 'Vous devez avoir une référence. Cela signifie que si vous êtes inscrit dans un plan de soins gérés, les soins doivent être autorisés soit par votre médecin de soins primaires, soit par Mobile Doctors.'
    },
    paymentOptions: {
    ...
    coverage: {
      ...
      features: [
        'Zone de service principale dans un rayon de 100 milles',
  ...
  hy: {
    hero: {
      title: 'Մեր առողջապահական ծառայությունները',
      subtitle: 'Մենք առաջարկում ենք համապարփակ պրոֆեսիոնալ տնային առողջապահական ծառայություններ, որոնք նախագծված են բավարարել ձեր հատուկ կարիքները և օգնել ձեզ պահպանել ձեր անկախությունը տանը:',
    },
    services: [
      {
        ...
        features: [
          ...
          'Օպտիմալ վերականգնման համար հետագա այցեր',
      ...
      {
        title: 'Ֆիզիոթերապևտ',
        description: 'Գնահատում և բուժում է հիվանդի շարժման ունակությունը: Սա կարող է ներառել. հետօրթոպեդիկ վիրահատությունից հետո կառավարում, քայլք/քայլելու մարզում, ROM/ուժեղացման վարժություններ, մահճակալի շարժունակություն, փոխանցումներ և տնային վարժությունների ծրագիր:',
        features: [
          'Հետօրթոպեդիկ վիրահատությունից հետո կառավարում',
          'Քայլք և քայլելու մարզում',
          'ROM և ուժեղացման վարժություններ',
          'Մահճակալի շարժունակության մարզում',
          'Փոխանցման օգնություն',
          'Տնային վարժությունների ծրագրի մշակում',
        ],
      },
      {
        title: 'Աշխատանքային թերապևտ',
        description: 'Մշակում է հիվանդի մարզման ծրագիր՝ վերականգնելու և պահպանելու առողջության, արտադրողականության և ամենօրյա կյանքի անկախության համար անհրաժեշտ հմտությունները:',
        features: [
          'Ամենօրյա գործունեության հմտությունների մարզում',
          'Առողջության պահպանման ծրագրեր',
          'Արտադրողականության բարձրացում',
          'Անկախության կառուցում',
          'Ադապտիվ տեխնիկաներ',
      ...
      {
        title: 'Խոսքի թերապևտ',
        description: 'Գնահատում է հիվանդի հաղորդակցության թերությունները, խոսքի և կլման ֆունկցիաների խանգարումները: Մշակում է թերապևտիկ վարժություններ մինչև հնարավոր օպտիմալ մակարդակ:',
        features: [
          'Հաղորդակցության թերությունների գնահատում',
          'Խոսքի խանգարումների գնահատում',
          'Կլման ֆունկցիայի գնահատում',
          'Թերապևտիկ վարժությունների մշակում',
          'Օպտիմալ ֆունկցիայի ձեռքբերում',
          'Հաղորդակցության բարելավում',
        ],
      },
      {
        title: 'Դիետոլոգ',
        description: 'Գնահատում է ընթացիկ դիետան և ապահովում խորհրդատվություն ամենօրյա սննդային ուղղորդման համար, որը կնպաստի բուժմանը և առողջության պահպանմանը:',
        features: [
          'Ընթացիկ դիետայի գնահատում',
          'Սննդային խորհրդատվություն',
          'Ամենօրյա ուղղորդման ապահովում',
          'Բուժման խթանում',
          'Առողջության պահպանման աջակցություն',
          'Անհատականացված սննդակարգի պլանավորում',
        ],
      },
      {
        title: 'Բժշկական սոցիալական ծառայություններ',
        description: 'Տրամադրում է օգնություն, որը կապված է հիվանդի բժշկական մտահոգությունների հետ, համայնքային ռեսուրսներ՝ նվազեցնելու սոցիալական, հուզական, շրջակա միջավայրային և ֆինանսական գործոնները, որոնք ազդում են հիվանդի բարեկեցության վրա:',
        features: [
          'Բժշկական մտահոգությունների օգնություն',
          'Համայնքային ռեսուրսների միացում',
          'Սոցիալական գործոնների նվազեցում',
          'Հուզական աջակցության ապահովում',
          'Շրջակա միջավայրային գործոնների կառավարում',
          'Ֆինանսական օգնության ուղղորդում',
        ],
      },
      {
        title: 'Տնային առողջապահական օգնականներ',
        description: 'Օգնում են հիվանդներին ամենօրյա կենսագործունեության գործողություններում, որոնք ներառում են անձնական խնամք, ինչպիսիք են լոգանքը, հագնվելը, զարդարվելը, կերակրելը և տնային շրջակա միջավայրի անվտանգությունը:',
        features: [
          'Անձնական խնամքի օգնություն',
          'Լոգանքի և հիգիենայի աջակցություն',
          'Հագնվելու և զարդարվելու օգնություն',
          'Կերակրման օգնություն',
          'Տնային անվտանգության կառավարում',
          'Ամենօրյա կենսագործունեության գործողություններ',
        ],
      },
    ],
    whoNeedsCare: {
      ...
      criteria: [
        ...
        'Երկարաժամկետ խնամքի հաստատությունում',
        'Ունի բժշկի հրամաններ, որոնք պահանջում են հմուտ բժշկական ծառայություններ',
        'Տնային խնամքի կարիք ունի',
      ],
      note: 'Դուք պետք է ունենաք ուղղորդում: Սա նշանակում է, որ եթե դուք գրանցված եք կառավարվող խնամքի ծրագրում, խնամքը պետք է լինի հաստատված կամ ձեր հիմնական խնամքի բժշկի կողմից, կամ Mobile Doctors-ի կողմից:',
    },
    paymentOptions: {
      title: 'Ո՞Վ Է ՎՃԱՐՈՒՄ ԱՅՍ ԾԱՌԱՅՈՒԹՅՈՒՆՆԵՐԻ ՀԱՄԱՐ',
      subtitle: 'Մենք աշխատում ենք տարբեր վճարման աղբյուրների հետ՝ մեր ծառայությունները հասանելի դարձնելու համար նրանց, ովքեր դրանց կարիք ունեն:',
      options: [
        {
          name: 'Medicare',
          description: 'Ծածկույթ Medicare ուղեցույցներին համապատասխանող իրավասու անձանց համար',
        },
        {
          name: 'Medi-Cal',
          description: 'Կալիֆոռնիայի Medicaid ծրագիր ցածր եկամուտ ունեցող անձանց համար',
        },
        {
          name: 'Մասնավոր ապահովագրություն',
          description: 'Ծածկույթը տարբերվում է ծրագրի և օգուտների կառուցվածքով',
        },
        {
          name: 'Մասնավոր վճարում',
    ...
    process: {
      ...
      subtitle: 'Մենք հեշտացնում ենք մեր տնային առողջապահական ծառայություններով սկսելը: Ահա մեր ուղղակի գործընթացը:',
      steps: [
        {
          step: '01',
          title: 'Նախնական գնահատում',
          description: 'Մենք իրականացնում ենք համապարփակ գնահատում ձեր առողջապահական կարիքների և տնային միջավայրի վերաբերյալ:',
        },
        {
          step: '02',
          title: 'Խնամքի ծրագրի մշակում',
          description: 'Մեր թիմը ստեղծում է անհատականացված խնամքի ծրագիր, որը հարմարեցված է ձեր հատուկ պահանջներին:',
        },
        {
          step: '03',
          title: 'Ծառայության իրականացում',
          description: 'Մենք սկսում ենք ապահովել ծառայություններ ձեր հաստատված խնամքի ծրագրի համաձայն:',
        },
        {
          step: '04',
          title: 'Շարունակական մոնիտորինգ',
          description: 'Կանոնավոր գնահատումներ և ճշգրտումներ՝ օպտիմալ խնամքի արդյունքներ ապահովելու համար:',
        },
      ],
    },
    coverage: {
      title: 'Ծառայության տարածքներ',
      subtitle: 'Մենք ապահովում ենք մեր տնային առողջապահական ծառայությունները ամբողջ մեծ մետրոպոլիտեն տարածքում, ապահովելով հարմար մուտք որակյալ խնամքի համար ձեզ և ձեր ընտանիքի համար:',
      features: [
        'Հիմնական ծառայության տարածք 100 մղոնի շրջանակում',
        'Ընդլայնված ծածկույթ հասանելի է հարցման դեպքում',
        '24/7 արտակարգ արձագանք հասանելի',
      ],
      ...
      businessHoursText: 'Երկուշաբթի - Ուրբաթ: 8:00 AM - 6:00 PM\nՇաբաթ: 9:00 AM - 2:00 PM',
      phone: 'Հեռախոս',
      coverageTitle: 'Ծածկույթի տարածք',
      coverageDescription: 'Կապվեք մեզ հետ՝ ձեր հատուկ գտնվելու վայրում ծառայության հասանելիությունը հաստատելու համար: Մենք նվիրված ենք մեր համայնքին սպասարկել հասանելի, որակյալ առողջապահությամբ:',
      checkAvailability: 'Ստուգել հասանելիությունը',
    },
    cta: {
      title: 'Պատրա՞ստ եք սկսել',
      subtitle: 'Կապվեք մեզ հետ այսօր՝ քննարկելու ձեր առողջապահական կարիքները և իմանալու, թե ինչպես մեր ծառայությունները կարող են օգնել ձեզ կամ ձեր սիրելիներին պահպանել անկախությունը տանը:',
  ...
  ru: {
    hero: {
      title: 'Наши услуги здравоохранения',
      subtitle: 'Мы предлагаем комплексный спектр профессиональных услуг домашнего здравоохранения, разработанных для удовлетворения ваших конкретных потребностей и помощи в поддержании независимости дома.',
    },
    services: [
      {
        ...
        features: [
          ...
          'Последующие визиты для оптимального восстановления',
      ...
      {
        title: 'Физиотерапевт',
        description: 'Оценивает и лечит способность пациента двигаться. Это может включать: управление после ортопедической хирургии, тренировку походки/ходьбы, упражнения ROM/укрепления, мобильность в постели, перемещения и программу домашних упражнений.',
        features: [
          'Управление после ортопедической хирургии',
          'Тренировка походки и ходьбы',
          'Упражнения ROM и укрепления',
          'Тренировка мобильности в постели',
          'Помощь при перемещениях',
          'Разработка программы домашних упражнений',
        ],
      },
      {
        title: 'Трудотерапевт',
        description: 'Разрабатывает программу обучения пациента для восстановления и поддержания навыков, необходимых для здоровья, продуктивности и независимости в повседневной жизни.',
        features: [
          'Обучение навыкам для повседневной деятельности',
      ...
      {
        title: 'Логопед',
        description: 'Оценивает дефекты в общении пациента, расстройства в функциях речи и глотания. Разрабатывает терапевтические упражнения до максимально возможного оптимального уровня.',
        features: [
          'Оценка дефектов общения',
          'Оценка речевых расстройств',
          'Оценка функции глотания',
          'Разработка терапевтических упражнений',
          'Достижение оптимальной функции',
          'Улучшение общения',
        ],
      },
      {
        title: 'Диетолог',
        description: 'Оценивает текущую диету и предоставляет консультации для ежедневного питания, которое будет способствовать заживлению и поддержанию здоровья.',
        features: [
          'Оценка текущей диеты',
          'Консультации по питанию',
          'Предоставление ежедневных рекомендаций',
          'Содействие заживлению',
          'Поддержка поддержания здоровья',
          'Персонализированное планирование питания',
        ],
      },
      {
        title: 'Медицинские Социальные Услуги',
        description: 'Оказывает помощь, связанную с медицинскими проблемами пациента, общественные ресурсы для облегчения социальных, эмоциональных, экологических и финансовых факторов, влияющих на благополучие пациента.',
        features: [
          'Помощь в медицинских проблемах',
          'Подключение к общественным ресурсам',
          'Облегчение социальных факторов',
          'Предоставление эмоциональной поддержки',
          'Управление экологическими факторами',
          'Руководство по финансовой помощи',
        ],
      },
      {
        title: 'Помощники по Домашнему Здоровью',
        description: 'Помогают пациентам с повседневными жизненными действиями, которые охватывают личный уход, такой как купание, одевание, уход за собой, кормление и безопасность домашней среды.',
        features: [
          'Помощь в личном уходе',
          'Поддержка купания и гигиены',
          'Помощь в одевании и уходе за собой',
          'Помощь в кормлении',
          'Управление безопасностью дома',
    ...
    whoNeedsCare: {
      ...
      criteria: [
        ...
        'В учреждении долгосрочного ухода',
        'Имеет назначения от врача, требующие квалифицированных медицинских услуг',
        'Прикован к дому',
      ],
      note: 'У вас должна быть направление. Это означает, что если вы зарегистрированы в плане управляемого ухода, уход должен быть авторизован либо вашим врачом первичной помощи, либо Mobile Doctors.',
    },
    paymentOptions: {
      title: 'КТО ПЛАТИТ ЗА ЭТИ УСЛУГИ?',
      subtitle: 'Мы работаем с различными источниками оплаты, чтобы сделать наши услуги доступными для тех, кто в них нуждается.',
      options: [
        {
          name: 'Medicare',
          description: 'Покрытие для подходящих лиц в соответствии с руководящими принципами Medicare',
        },
        {
          name: 'Medi-Cal',
          description: 'Программа Medicaid Калифорнии для лиц с низким доходом',
        },
        {
          name: 'Частное Страхование',
          description: 'Покрытие варьируется в зависимости от плана и структуры льгот',
        },
        {
          name: 'Частная Оплата',
    ...
    process: {
      ...
      subtitle: 'Мы упрощаем начало работы с нашими услугами домашнего здравоохранения. Вот наш простой процесс.',
      steps: [
        {
          step: '01',
          title: 'Первоначальная оценка',
          description: 'Мы проводим комплексную оценку ваших потребностей в здравоохранении и домашней обстановки.',
        },
        {
          step: '02',
          title: 'Разработка плана ухода',
          description: 'Наша команда создает персонализированный план ухода, адаптированный к вашим конкретным требованиям.',
        },
        {
          step: '03',
          title: 'Реализация услуги',
          description: 'Мы начинаем предоставлять услуги в соответствии с вашим утвержденным планом ухода.',
        },
        {
          step: '04',
          title: 'Непрерывный мониторинг',
          description: 'Регулярные оценки и корректировки для обеспечения оптимальных результатов ухода.',
        },
      ],
    },
    coverage: {
      title: 'Области Обслуживания',
      subtitle: 'Мы предоставляем наши услуги домашнего здравоохранения по всему большому мегаполису, обеспечивая удобный доступ к качественному уходу для вас и вашей семьи.',
      features: [
        'Основная область обслуживания в пределах 100 миль',
        'Расширенное покрытие доступно по запросу',
        'Доступна круглосуточная экстренная помощь',
      ],
      ...
      businessHoursText: 'Понедельник - Пятница: 8:00 AM - 6:00 PM\nСуббота: 9:00 AM - 2:00 PM',
      phone: 'Телефон',
      coverageTitle: 'Область Покрытия',
      coverageDescription: 'Свяжитесь с нами, чтобы подтвердить доступность услуги в вашем конкретном местоположении. Мы стремимся служить нашему сообществу доступным, качественным здравоохранением.',
      checkAvailability: 'Проверить Доступность',
    },
    cta: {
      title: 'Готовы начать?',
      subtitle: 'Свяжитесь с нами сегодня, чтобы обсудить ваши потребности в здравоохранении и узнать, как наши услуги могут помочь вам или вашим близким поддерживать независимость дома.',
